...
" Modified:     Ross Owen for XC keys and XC io statements
...
" XC keywords
syn keyword     cXcPar          par
syn keyword     cXcSelect       select
syn keyword     cXcWhen         when
syn keyword     cXcAfter        after
syn keyword     cXcTypes        inport outport clock chan chanend timer clocked in out port tileref chanend\? buffered streaming
...
syn keyword	cTodo		contained TODO FIXME HACK XXX
...
elseif exists("c_no_bracket_error")
  ...
  " NOTE: MODIFIED FOR XC :> and <: operators (plus xc doesnt support this
  " anyway
...
syn keyword	cType		uint int long short char void
...
hi def link cXcTypes            Type
hi def link cXcPar              Repeat
hi def link cXcSelect           Conditional
hi def link cXcWhen             Conditional
hi def link cXcAfter            Conditional

let b:current_syntax = "xc"
let b:current_syntax = "xm"
" vim: ts=8
